...
// Workshop 1 Wail Mardini - 2022/07/04 Cornel - 2022/09/08
...
int main(int argc, char* argv[]) {
   ...
   for (auto ad = 1; ad < argc; ++ad) {
      ...
      if (ad == 1) { // special day! no tax for all cars and 10% discount for
         // applicable cars!
         g_taxrate = 0;
         g_discount = 0.10;
      }
      ...
      // each parameter contains the orders from one day, process each one at a
      // time
...
/* input file format: a comma separated set of fields with a consistent format
of <Order Tag>,<Car Brand>,<Car Model>,<Year>,<Price>,<Discount status> e.g.:
